...
-- WoW API
local GameFontNormalLarge, CLASS_ICON_TCOORDS = GameFontNormalLarge, CLASS_ICON_TCOORDS
...
setmetatable(TheClassicRaceStatusFrame, {__call = function(cls, ...) return cls.new(...) end})
