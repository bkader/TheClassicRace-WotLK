...
setmetatable(TheClassicRaceChatNotifier, {__call = function(cls, ...) return cls.new(...) end})
...
function TheClassicRaceChatNotifier:ShouldReport(playerInfo, globalRank, classRank)
	...
	if
		playerInfo.dingedAt < self.Core:Now() - 600 and
		(globalRank == nil or globalRank > 1) and
		(classRank == nil or classRank > 1)
	then
		return false
	end
...
function TheClassicRaceChatNotifier:DingNotification(playerInfo, globalRank, classRank, isSelf)
	...
	elseif classRank == 1 and globalRank ~= nil then
		if playerInfo.level == self.Config.MaxLevel then
			TheClassicRace:PPrint("Gratz! The race is over! " .. addressPerson .. " the first to reach max level of all " .. prettyClassName .. ", and #" .. globalRank .. " for all classes!!")
		else
			TheClassicRace:PPrint("Gratz! " .. addressPerson .. " first to reach level " .. playerInfo.level .. " of all " .. prettyClassName .. ", and #" .. globalRank .. " for all classes!")
		end
	elseif classRank == 1 then
		if playerInfo.level == self.Config.MaxLevel then
			TheClassicRace:PPrint("Gratz! The race is over! " .. addressPerson .. " the first to reach max level of all " .. prettyClassName .. "!! (not in top " .. self.Config.MaxLeaderboardSize .. " for all classes)")
		else
			TheClassicRace:PPrint("Gratz! " .. addressPerson .. " first to reach level " .. playerInfo.level .. " of all " .. prettyClassName .. "!! (not in top " .. self.Config.MaxLeaderboardSize .. " for all classes)")
		end
	elseif globalRank ~= nil then
		if playerInfo.level == self.Config.MaxLevel then
			TheClassicRace:PPrint("Gratz!  " .. chatLink .. " reached max level as #" .. classRank .. " of all " .. prettyClassName .. ", " .. "and #" .. globalRank .. " for all classes!!")
		else
			TheClassicRace:PPrint("Gratz! " .. chatLink .. " reached level " .. playerInfo.level .. "! " .. "Currently rank #" .. classRank .. " of all " .. prettyClassName .. " and #" .. globalRank .. " for all classes in the race!")
		end
	else
		if playerInfo.level == self.Config.MaxLevel then
			TheClassicRace:PPrint("Gratz!  " .. chatLink .. " reached max level as #" .. classRank .. " of all " .. prettyClassName .. "!" .. " (not in top " .. self.Config.MaxLeaderboardSize .. " for all classes)")
		else
			TheClassicRace:PPrint("Gratz! " .. chatLink .. " reached level " .. playerInfo.level .. " as #" .. classRank .. " of all " .. prettyClassName .. "! (not in top " .. self.Config.MaxLeaderboardSize .. " for all classes)")
		end
	end
end
